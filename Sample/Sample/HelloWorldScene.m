...
-(void) doTest
{
	...
	CCTexture2DMutable *mutableTexture = [[[CCTexture2DMutable alloc] initWithCGImage:[[UIImage imageNamed:@"example.png"] CGImage] resolutionType:kCCResolutioniPhone] autorelease];
